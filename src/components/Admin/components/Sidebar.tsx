...
const Sidebar = () => {
  ...
  const menu = [
    { path: '/', label: 'Головна', icon: <FaTachometerAlt /> },
    { path: '/users', label: 'Користувачі', icon: <FaUsers /> },
    { path: '/texts', label: 'Тексти', icon: <FaListAlt /> },
    { path: '/leaders', label: 'Лідери дня', icon: <FaUsersCog /> },
    { path: '/settings', label: 'Налаштування', icon: <FaCogs /> },
  ];
